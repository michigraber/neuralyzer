'''
Implementation of the foopsi algorithm from [1] on the basis of the the cvxpython
library.
...
def cvx_foopsi(y, w=None, spks=None, p=2, noise_range=(.25, .5), solver='ECOS',
    ...
    events = np.dot(G, c__).clip(0, np.inf)
