...
Mostly copied from the Jupyter stack : https://github.com/jupyter/docker-stacks/tree/master/minimal-notebook
...
-e PORT=8888 - Configures Jupyter Notebook to listen on the given port.
Defaults to 8888, which is the port exposed within the Dockerfile for the
image. When using Docker's --net=host, you may wish to use this option to
specify a particular port.
